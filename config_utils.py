...
CONFIG_SECTIONS: dict[str, str] = {
    ...
    "mail_processing_provider_id": "mail_ai_settings",
    "mail_summary_prompt": "mail_ai_settings",
    "mail_translation_prompt": "mail_ai_settings",
    "translation_language": "mail_ai_settings",
    "webui_auto_show_cached_ai": "webui_settings",
    "mail_verification_cooldown_minutes": "webui_settings",
    "mail_processing_body_max_chars": "mail_ai_settings",
    "mail_processing_max_tokens": "mail_ai_settings",
